...
class InfoScreen(Screen):
    ...
    def rebuild_ui(self):
        ...
        self.scroll_content.add_widget(self._create_link_button(
            f"f - {_('fb_club')}", "https://www.facebook.com/fcvaldahonvercel/", user_size
        ))
        
        self.scroll_content.add_widget(self._create_link_button(
            "Instagram", "https://www.instagram.com/fc_valdahon_vercel/", user_size
        ))

        # --- SECTION 2 : LE TOURNOI (DÉPLACÉ AU MILIEU) ---
        ...
        self.scroll_content.add_widget(self._create_link_button(
            f"f - {_('fb_tournament')}", "https://www.facebook.com/TournoideVercel/", user_size
        ))

        # --- SECTION 3 : ACCÈS AU GYMNASE (DÉPLACÉ EN BAS) ---
        self.scroll_content.add_widget(BoxLayout(size_hint_y=None, height=dp(10)))
        ...
        self.scroll_content.add_widget(self._create_link_button(
            _('open_maps'), "https://maps.google.com/?q=18+Rue+du+Stade+25530+Vercel", user_size
        ))
