...
class ClassementScreen(Screen):
    ...
    def _check_scroll_limit(self, instance, value):
        """Déclenche le refresh si on tire le tableau vers le bas"""
    ...
    def update_ui_from_config(self, *args):
        ...
        # --- GESTION DU HASH ---
        # On inclut l'index de l'équipe et la police dans le hash
        data_to_hash = {
        ...
        # Construction du sélecteur d'onglets
    ...
    def render_table(self, data, f_factor):
        ...
        main_scroll = ScrollView(
            ...
            bar_width=dp(2), scroll_type=['content']
        )
        # On lie le scroll_y du tableau pour le refresh
