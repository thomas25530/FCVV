...
class EventCard(BoxLayout):
    ...
    def __init__(self, match_id, match_data, categorie=None, on_presence_click=None, **kwargs):
        ...
        date_box = BoxLayout(orientation="vertical", size_hint_x=0.2, spacing=dp(1), size_hint_y=None,pos_hint={"top": 1})
        ...
        # COLONNE DROITE
        # --------------------------------------------------
        title_box = BoxLayout(orientation="vertical",size_hint_x=0.8,spacing=dp(6),padding=[dp(18), 0, 0, 0],size_hint_y=None,)
